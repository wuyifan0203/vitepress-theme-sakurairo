 ...
 * @LastEditTime: 2024-02-19 13:35:11
 * @FilePath: /vitepress-theme-sakurairo/.vitepress/theme/layout/cover/Cover.vue
-->
<template>
    <section ref="coverRef">
        ...
        <div class="cover-wave1" style="background: url(/vitepress-theme-sakurairo/.vitepress/theme/image/wave1.png) repeat-x;"></div>
        <div class="cover-wave2" style="background: url(/vitepress-theme-sakurairo/.vitepress/theme/image/wave2.png) repeat-x;"></div>
...
const basePath = '/vitepress-theme-sakurairo/.vitepress/theme/icon/';
const iconMap = {
